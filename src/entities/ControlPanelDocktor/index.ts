...
export type { ProccessControlPanelDoctorSchema } from './model/types/controlPanelDocktorSchema';
export type { ProccesApiResponseControlPanelDoctorTypes } from './model/types/controlPanelDocktorTypes';
