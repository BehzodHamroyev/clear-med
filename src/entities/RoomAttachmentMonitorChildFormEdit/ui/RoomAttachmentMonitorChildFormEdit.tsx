...
import cls from './RoomAttachmentMonitorChildFormEdit.module.scss';
...
const RoomAttachmentMonitorChildFormEdit = () => {
  /* translation */
  ...
  return (
    <div
      ...
      onClick={(e) => {
        e.stopPropagation();
        setIsOpenRoomAttachmentMonitorChildFormEdit(false);
      }}
    >
      <div
        onClick={(e) => {
...
export default RoomAttachmentMonitorChildFormEdit;
